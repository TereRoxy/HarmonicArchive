    ...
    public static class MusicSheetGenerator
    {
        public static List<MusicSheetDto> GenerateMusicSheets(int count)
        {
            ...
            var musicSheetDtoFaker = new Faker<MusicSheetDto>()
                ...
                .RuleFor(dto => dto.MusicFile, f => null) // Set MusicFile to null (file uploads are not handled here)
                .RuleFor(dto => dto.VideoFile, f => null); // Set VideoFile to null (file uploads are not handled here)
